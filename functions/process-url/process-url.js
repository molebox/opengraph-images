...
exports.handler = async function (event, ctx) {
  ...
  try {
    const imageUrl = `https://res.cloudinary.com/richardhaines/image/fetch/${encodeURIComponent(
      `https://vigilant-jones-f0730c.netlify.app/.netlify/functions/gen-opengraph-image?${qs.stringify(
